...
export default function FilterForm() {
    ...
    const handleTagChange = (category, index, tag) => {
        ...
        const type = category === 'tech' ? 'techTags' : 'projectTags'
        dispatch(toggleTagFilter({tag: tag, type: type}))
    };

    // TODO: Add filtering options for the rest of the tags with some way to 
    //   show more or search for them.
    //   May need to update the form structure when this happens (already a bit chunky/repetitive as is)
    return (
        <Box pl='5%' textAlign='left'>
            ...
            <Stack direction='column' pb='20px'>
                <Checkbox
                    ...
                    onChange={() => handleTagChange('project', 0, 'AI Development')}
                    >AI Development
                </Checkbox>
                <Checkbox
